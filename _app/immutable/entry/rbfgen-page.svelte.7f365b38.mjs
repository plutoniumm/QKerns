import{S as nn,i as an,s as rn,k as a,q as t,a as m,l as i,m as h,r as n,h as l,c as v,n as en,b as H,F as e,K as wt}from"../chunks/index.a4d57a87.mjs";function ln(tn){let w,j,L,f,R,O,P,r,U,A,Q,xt="{d(x,x')}",X,kt="{2*\rho^2}",Y,Z,ee,te,ne,ae,gt="{2^{1-\\nu}}",ie,Bt="{\\Gamma(\\nu)}",re,le,Mt="{\\sqrt{2\\nu}d(x,x')}",se,Tt="{\\rho}",oe,he,Et="{\\nu}",de,ce,Rt="{\\sqrt{2\\nu}d(x,x')}",ue,It="{\\rho}",fe,$e,Ft="{\\nu}",me,ve,be,I,pe,ye,u,_e,we,xe,ke,ge,Be,Me,Te,Ee,Re,Ie,Fe,qe,E,F,Ke,De,b,x,q,Ge,Se,qt="{-d}",ze,Je,Ce,k,K,He,Le,Kt="{-\\sqrt(3) d}",Ne,Ve,We,p,D,je,Oe,Dt=5+"",Pe,Gt=3+"",Ue,Ae,St="{-\\sqrt(5) d}",Qe,Xe,Ye,g,G,Ze,et,zt="{-\\frac{d^2}{2}}",tt,nt,N,_,S,at,it,o,rt,lt,st,Jt="{2^{1-\\nu}}",ot,Ct="{\\Gamma(\\nu)}",ht,dt,Ht="{\\sqrt{2\\nu}d(x,x')}",ct,Lt="{\\rho}",ut,ft,Nt="{\\nu}",$t,mt,Vt="{\\sqrt{2\\nu}d(x,x')}",vt,Wt="{\\rho}",bt,pt,jt="{\\nu}",yt,_t;return{c(){w=a("h1"),j=t("Kernel Generalisations"),L=m(),f=a("section"),R=a("h2"),O=t("RBF $\\rightarrow$ Matern"),P=m(),r=a("div"),U=t(`The RBF kernel is defined as
    ...
    dependent on the distance between them making it much more flexible. Non-stationary
    kernels have proved to be very useful for modeling data that exhibit spatially
    varying behavior, such as weather patterns or population density. `),Fe=i($,"BR",{}),$.forEach(l),qe=v(y),E=i(y,"DIV",{});var V=h(E);F=i(V,"H4",{});var Ut=h(F);Ke=n(Ut,"Special Cases"),Ut.forEach(l),De=v(V),b=i(V,"UL",{});var M=h(b);x=i(M,"LI",{});var z=h(x);q=i(z,"B",{});var At=h(q);Ge=n(At,"nu = 0.5:"),At.forEach(l),Se=n(z," Matern reduces to $e^"),ze=n(z,qt),Je=n(z,"$ i.e exponential distance"),z.forEach(l),Ce=v(M),k=i(M,"LI",{});var J=h(k);K=i(J,"B",{});var Qt=h(K);He=n(Qt,"nu = 1.5:"),Qt.forEach(l),Le=n(J," Matern reduces to $(1+ \\sqrt(3) d) e^"),Ne=n(J,Kt),Ve=n(J,"$"),J.forEach(l),We=v(M),p=i(M,"LI",{});var T=h(p);D=i(T,"B",{});var Xt=h(D);je=n(Xt,"nu = 2.5:"),Xt.forEach(l),Oe=n(T," Matern reduces to $(1+ \\sqrt(5) d + \\frac"),Pe=n(T,Dt),Ue=n(T,Gt),Ae=n(T," d^2) e^"),Qe=n(T,St),Xe=n(T,"$"),T.forEach(l),Ye=v(M),g=i(M,"LI",{});var C=h(g);G=i(C,"B",{});var Yt=h(G);Ze=n(Yt,"nu = $\\infty$"),Yt.forEach(l),et=n(C," Matern reduces to $e^"),tt=n(C,zt),nt=n(C,`$ i.e RBF
        kernel`),C.forEach(l),M.forEach(l),V.forEach(l),y.forEach(l),N=v(d),_=i(d,"SECTION",{class:!0});var W=h(_);S=i(W,"H2",{});var Zt=h(S);at=n(Zt,"Matern $\\rightarrow$ Wendland"),Zt.forEach(l),it=v(W),o=i(W,"DIV",{});var c=h(o);rt=n(c,`The Matern kernel is defined as
    `),lt=i(c,"BR",{}),st=n(c," $$ k(x,x') = \\frac"),ot=n(c,Jt),ht=n(c,Ct),dt=n(c,"\\left(\\frac"),ct=n(c,Ht),ut=n(c,Lt),ft=n(c,`\\right)^\\nu
