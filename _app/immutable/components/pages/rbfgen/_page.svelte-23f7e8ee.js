import{S as nn,i as an,s as rn,k as a,q as t,a as m,l as i,m as h,r as n,h as l,c as v,n as en,b as H,F as e,C as wt}from"../../../chunks/index-7af328a4.js";function ln(tn){let w,j,L,f,R,O,P,r,U,A,Q,xt="{d(x,x')}",X,kt="{2*\rho^2}",Y,Z,ee,te,ne,ae,gt="{2^{1-\\nu}}",ie,Bt="{\\Gamma(\\nu)}",re,le,Mt="{\\sqrt{2\\nu}d(x,x')}",se,Tt="{\\rho}",oe,he,Et="{\\nu}",de,ce,Rt="{\\sqrt{2\\nu}d(x,x')}",ue,It="{\\rho}",fe,$e,Ft="{\\nu}",me,ve,be,I,pe,ye,u,_e,we,xe,ke,ge,Be,Me,Te,Ee,Re,Ie,Fe,qe,E,F,Ke,De,b,x,q,Ge,Se,qt="{-d}",ze,Ce,Je,k,K,He,Le,Kt="{-\\sqrt(3) d}",Ne,Ve,We,p,D,je,Oe,Dt=5+"",Pe,Gt=3+"",Ue,Ae,St="{-\\sqrt(5) d}",Qe,Xe,Ye,g,G,Ze,et,zt="{-\\frac{d^2}{2}}",tt,nt,N,_,S,at,it,o,rt,lt,st,Ct="{2^{1-\\nu}}",ot,Jt="{\\Gamma(\\nu)}",ht,dt,Ht="{\\sqrt{2\\nu}d(x,x')}",ct,Lt="{\\rho}",ut,ft,Nt="{\\nu}",$t,mt,Vt="{\\sqrt{2\\nu}d(x,x')}",vt,Wt="{\\rho}",bt,pt,jt="{\\nu}",yt,_t;return{c(){w=a("h1"),j=t("Kernel Generalisations"),L=m(),f=a("section"),R=a("h2"),O=t("RBF $\\rightarrow$ Matern"),P=m(),r=a("div"),U=t(`The RBF kernel is defined as
    `),A=a("br"),Q=t(" $$ k(x,x') = \\exp\\left(-\\frac"),X=t(xt),Y=t(kt),Z=t(`\\right) $$
    ...
    $\\Gamma$ is the gamma function. The parameter $\\nu$ controls the smoothness
    of the function.`),this.h()},l(d){w=i(d,"H1",{});var B=h(w);j=n(B,"Kernel Generalisations"),B.forEach(l),L=v(d),f=i(d,"SECTION",{class:!0});var y=h(f);R=i(y,"H2",{});var Ot=h(R);O=n(Ot,"RBF $\\rightarrow$ Matern"),Ot.forEach(l),P=v(y),r=i(y,"DIV",{});var s=h(r);U=n(s,`The RBF kernel is defined as
    `),A=i(s,"BR",{}),Q=n(s," $$ k(x,x') = \\exp\\left(-\\frac"),X=n(s,xt),Y=n(s,kt),Z=n(s,`\\right) $$
    where $d(x,x') \\geq 0$ is the Euclidean distance between $x$ and $x'$ and
    $\\rho$ is a hyperparameter. The RBF kernel is infinitely differentiable and
    is positive definite.
    `),ee=i(s,"BR",{}),te=n(s,`
    ...
    dependent on the distance between them making it much more flexible. Non-stationary
    kernels have proved to be very useful for modeling data that exhibit spatially
    varying behavior, such as weather patterns or population density. `),Fe=i($,"BR",{}),$.forEach(l),qe=v(y),E=i(y,"DIV",{});var V=h(E);F=i(V,"H4",{});var Ut=h(F);Ke=n(Ut,"Special Cases"),Ut.forEach(l),De=v(V),b=i(V,"UL",{});var M=h(b);x=i(M,"LI",{});var z=h(x);q=i(z,"B",{});var At=h(q);Ge=n(At,"nu = 0.5:"),At.forEach(l),Se=n(z," Matern reduces to $e^"),ze=n(z,qt),Ce=n(z,"$ i.e exponential distance"),z.forEach(l),Je=v(M),k=i(M,"LI",{});var C=h(k);K=i(C,"B",{});var Qt=h(K);He=n(Qt,"nu = 1.5:"),Qt.forEach(l),Le=n(C," Matern reduces to $(1+ \\sqrt(3) d) e^"),Ne=n(C,Kt),Ve=n(C,"$"),C.forEach(l),We=v(M),p=i(M,"LI",{});var T=h(p);D=i(T,"B",{});var Xt=h(D);je=n(Xt,"nu = 2.5:"),Xt.forEach(l),Oe=n(T," Matern reduces to $(1+ \\sqrt(5) d + \\frac"),Pe=n(T,Dt),Ue=n(T,Gt),Ae=n(T," d^2) e^"),Qe=n(T,St),Xe=n(T,"$"),T.forEach(l),Ye=v(M),g=i(M,"LI",{});var J=h(g);G=i(J,"B",{});var Yt=h(G);Ze=n(Yt,"nu = $\\infty$"),Yt.forEach(l),et=n(J," Matern reduces to $e^"),tt=n(J,zt),nt=n(J,`$ i.e RBF
        kernel`),J.forEach(l),M.forEach(l),V.forEach(l),y.forEach(l),N=v(d),_=i(d,"SECTION",{class:!0});var W=h(_);S=i(W,"H2",{});var Zt=h(S);at=n(Zt,"Matern $\\rightarrow$ Wendland"),Zt.forEach(l),it=v(W),o=i(W,"DIV",{});var c=h(o);rt=n(c,`The Matern kernel is defined as
    `),lt=i(c,"BR",{}),st=n(c," $$ k(x,x') = \\frac"),ot=n(c,Ct),ht=n(c,Jt),dt=n(c,"\\left(\\frac"),ct=n(c,Ht),ut=n(c,Lt),ft=n(c,`\\right)^\\nu
    ...
    $\\Gamma$ is the gamma function. The parameter $\\nu$ controls the smoothness
    of the function.`),c.forEach(l),W.forEach(l),this.h()},h(){en(f,"class","svelte-2crdhv"),en(_,"class","svelte-2crdhv")},m(d,B){H(d,w,B),e(w,j),H(d,L,B),H(d,f,B),e(f,R),e(R,O),e(f,P),e(f,r),e(r,U),e(r,A),e(r,Q),e(r,X),e(r,Y),e(r,Z),e(r,ee),e(r,te),e(r,ne),e(r,ae),e(r,ie),e(r,re),e(r,le),e(r,se),e(r,oe),e(r,he),e(r,de),e(r,ce),e(r,ue),e(r,fe),e(r,$e),e(r,me),e(r,ve),e(f,be),e(f,I),e(I,pe),e(f,ye),e(f,u),e(u,_e),e(u,we),e(u,xe),e(u,ke),e(u,ge),e(u,Be),e(u,Me),e(u,Te),e(u,Ee),e(u,Re),e(u,Ie),e(u,Fe),e(f,qe),e(f,E),e(E,F),e(F,Ke),e(E,De),e(E,b),e(b,x),e(x,q),e(q,Ge),e(x,Se),e(x,ze),e(x,Ce),e(b,Je),e(b,k),e(k,K),e(K,He),e(k,Le),e(k,Ne),e(k,Ve),e(b,We),e(b,p),e(p,D),e(D,je),e(p,Oe),e(p,Pe),e(p,Ue),e(p,Ae),e(p,Qe),e(p,Xe),e(b,Ye),e(b,g),e(g,G),e(G,Ze),e(g,et),e(g,tt),e(g,nt),H(d,N,B),H(d,_,B),e(_,S),e(S,at),e(_,it),e(_,o),e(o,rt),e(o,lt),e(o,st),e(o,ot),e(o,ht),e(o,dt),e(o,ct),e(o,ut),e(o,ft),e(o,$t),e(o,mt),e(o,vt),e(o,bt),e(o,pt),e(o,yt),e(o,_t)},p:wt,i:wt,o:wt,d(d){d&&l(w),d&&l(L),d&&l(f),d&&l(N),d&&l(_)}}}class on extends nn{constructor(w){super(),an(this,w,null,ln,rn,{})}}export{on as default};
